...
if (session_status() === PHP_SESSION_NONE) {
	// Configurar cookies de sesión para que funcionen con CORS
...
$allowedOrigins = [
	'http://localhost',
	'http://localhost:8080',
	'https://pourfect.ezsoft.com.ar',
	'http://pourfect.ezsoft.com.ar'
];
...
if (in_array($origin, $allowedOrigins)) {
	...
	// Si no hay origen o no está en la lista, permitir todos (sin credenciales)
